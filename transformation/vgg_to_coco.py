...
vgg_json_path = '/Users/bparners/Downloads/vgg_annotations-val.json'
# Chemin de sortie pour le fichier COCO
coco_json_path = '/Users/bparners/Downloads/coco_annotations-val.json'
